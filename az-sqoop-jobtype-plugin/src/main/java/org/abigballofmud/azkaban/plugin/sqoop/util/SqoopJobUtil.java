package org.abigballofmud.azkaban.plugin.sqoop.util;
...
public class SqoopJobUtil {
    ...
    public static String replacePlaceHolderForJson(String content, Map<String, String> params) {
        // 处理job传的参数
        ...
        // 处理内置参数
        return ParamsUtil.handlePredefinedParams(content);
    }
